...
export class StringUtils {
	...
	static capitalize(string: string): string {
		if (!TypeUtils.isString(string)) throw Error('StringUtils.capitalize can only accept strings')
	 ...
	 * @param capitalize should capitalize words
	 */
	static toKebabCase(string: string, capitalize = false): string {
		return StringUtils.toWordArray(string)
			.map((word) => word.trim())
			.map((word) => {
	 ...
	 * @param capitalize should capitalize words
	 */
	static toSnakeCase(string: string, capitalize = false): string {
		return StringUtils.toWordArray(string)
			.map((word) => word.trim())
			.map((word) => {
				if (capitalize) return StringUtils.capitalize(word)
...
export const contains = StringUtils.contains.bind(StringUtils)
export const capitalize = StringUtils.capitalize.bind(StringUtils)
export const toCamelCase = StringUtils.toCamelCase.bind(StringUtils)
export const toKebabCase = StringUtils.toKebabCase.bind(StringUtils)
export const toSnakeCase = StringUtils.toSnakeCase.bind(StringUtils)
export const toReadable = StringUtils.toReadable.bind(StringUtils)
export const toWordArray = StringUtils.toWordArray.bind(StringUtils)
